    ...
    <div class="wrap">
		...
		<div class="clear"></div>
    	  ...
    	  <div class="clear"></div>
    	    ...
    	    <div class="clear"></div>
    		<form id='register' onsubmit="return checkCard();" method="POST" action="PayAdJCC.php" accept-charset="UTF-8"> 
    		<table>
    		<thead>
		      <tr>
			...
			<br>
			<br>
    		<button type="submit" class="grey" name="submit" value="Submit">ΠΛΗΡΩΜΗ</button>
 			</form>
			</div>   
