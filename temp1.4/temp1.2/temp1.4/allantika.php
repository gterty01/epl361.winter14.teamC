  ...
  <div class="main">
     <div class="wrap">
		<div class="cont span_2_of_3">
		  	<h2 class="head">τροφιμα - αλλαντικα</h2>
        ...
        <div class="pager">   
            ...
            <select>
       		...
       		<ul class="dc_pagination dc_paginationA dc_paginationA06">
			    <li><a href="#" class="previous">Σελίδες</a></li>
			    <li><a href="#">1</a></li>
			    <li><a href="#">2</a></li>
		  	</ul>
	   		<div class="clear"></div>
     	...
     	<div class="clear"></div>
			...
			<div class="top-box">
			 <div class="col_1_of_3 span_1_of_3"> 
			   <a href="single.html">
				<div class="inner_content clearfix">
					<div class="product_image">
						<img src="images/tsamarela.jpg" alt="" width="270" height="250"/>
					</div>
                    <div class="sale-box"><span class="on_sale title_shop">New</span></div>	
                    <div class="price">
					   <div class="cart-left">
							<p class="title">Κυπριακή Τσαμαρέλλα</p>
							<div class="price1">
							  <span class="actual">€5.00</span>
							</div>
						</div>
			   ...
			   <div class="col_1_of_3 span_1_of_3">
					...
					<div class="inner_content clearfix">
					<div class="product_image">
						<img src="images/salami2.jpg" alt="" width="270" height="250"/>
					</div>
                    <div class="price">
					   <div class="cart-left">
							<p class="title">Σαλάμι</p>
							<div class="price1">
			...
			<div class="top-box">
			  <div class="col_1_of_3 span_1_of_3">
				 ...
				 <div class="inner_content clearfix">
					<div class="product_image">
						<img src="images/galo2.jpg" alt="" width="270" height="250"/>
					</div>
                    <div class="price">
					   <div class="cart-left">
							<p class="title">Καπνιστή Γαλοπούλα</p>
							<div class="price1">
				...
				<div class="col_1_of_3 span_1_of_3">
					...
					<div class="inner_content clearfix">
					<div class="product_image">
						<img src="images/loutzaPitsi.jpg" alt="" width="270" height="250"/>
					</div>
					 <div class="sale-box"><span class="on_sale title_shop">New</span></div>	
                    <div class="price">
					   <div class="cart-left">
							<p class="title">Λούντζα Πιτσιλιάς</p>
							<div class="price1">
				...
				<div class="col_1_of_3 span_1_of_3">
				 ...
				 <div class="inner_content clearfix">
                    ...
                    <div class="price">
					   <div class="cart-left">
							<p class="title">Κρασάτα Λουκάνικα</p>
							<div class="price1">
			...
			<div class="rsidebar span_1_of_left">
                   ...
                   <section  class="sky-form">
					...
					<h4>Τιμή</h4>
						<div class="row row1 scroll-pane">
							<div class="col col-4">
								<label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i></i>€1,00 - €5,00</label>
							</div>
							<div class="col col-4">
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>€1,00 - €10,00</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>€1,00 - €15,00</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>€1,00 - €20,00</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>€1,00 - €25,00</label>
								<label class="checkbox"><input type="checkbox" name="checkbox" ><i></i>€1,00 - €50,00</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>€1,00 - €75,00</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>€1,00 - €100,00</label>
				...
				<section  class="sky-form">
					<h4>Μαρκα</h4>
						<div class="row row1 scroll-pane">
							<div class="col col-4">
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Snack</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Γρηγορίου</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Μητρομιλίδης</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Γιαγιά</label>
								<label class="checkbox"><input type="checkbox" name="checkbox" ><i></i>Αλλαντικά Αγρού</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Σπιτικά Προϊόντα</label>
								<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Άλλο</label>
							</div>
						</div>
		       </section>
