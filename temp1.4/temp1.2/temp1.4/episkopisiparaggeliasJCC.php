...
if ($_SESSION['troposplirwmis']=='antikataboli'){
header("Location: antikataboliJCC.php");
die;
...
$surn2=$_SESSION['surnSent'];
	echo "<form method='post' action='oloklirwsiParaggeliasJCC.php' name='formaproiontwn'>";
echo "<div class='wrap'>";
	...
	echo "</div>";
	echo "</form>";
	echo "<form method='post' action='allagidiefthinsisJCC.php' name='formaallagwn'>";
	echo 	"<button type='submit' class='grey' name='submitdiefthinsi' value='Επεξεργασια Διευθυνσης'>Επεξεργασια Διευθυνσης</button>";
	echo "</form>";
