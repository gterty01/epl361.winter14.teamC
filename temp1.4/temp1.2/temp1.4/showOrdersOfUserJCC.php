...
<h4 class="title">Παραγγελιες που Εκκρεμουν</h4>
	<form method="post" name="formadiagrafis">
  ...
  <table class="responsive" summary="Cart of User" style="width:91%; align:center;" id="proiontakalathiou">
   <!-- <thead>
    ...
    <?php
        ...
        echo '<th scope="col">Με αντικαταβολή</th>';
    	...
    	echo '<tbody>';
			while($row = $result->fetch_assoc()) {
				...
				echo '<tr onclick="window.location.href= \'showProductsOfOrderJCC.php?order='.urlencode($code).' \'">';
				if ($anti=="ΟΧΙ"){
