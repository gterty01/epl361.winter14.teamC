...
<div class="wrap">
	<h4 class="title">Προϊοντα</h4>
			...
			<?php
				...
				if ($rowAnti['antikataboli']=="ΟΧΙ"){
					echo "<h1 class='remove'>Διεύθυνση Αποστολής</h1>";
					echo "<div class='clear'></div>";
					echo "<p class='m_text2'>"; echo $rowAnti['AddressSent']; echo "</p>";
					echo "<p class='m_text2'>"; echo $rowAnti['citySent']; echo " - "; echo $rowAnti['postalSent']; echo "</p>";
...
<form id='imerominiaApostolis' method="post" onsubmit="return check()" action="manageEditOrder_databaseJCC.php" name="imerominiaApostolis">			
