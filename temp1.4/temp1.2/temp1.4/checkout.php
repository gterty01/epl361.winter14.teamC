...
echo			"</ul>";
     ...
     <br>
      ...
      <div class="register_account">
           <div class="wrap">
    	     <h4 class="title">το καλαθι ειναι αδειο</h4>
    	     <p class="cart">Δεν υπάρχουν προϊόντα στο καλάθι. <br>Πατήστε<a href="index.php"> εδώ</a> για να συνεχίσετε τις αγορές σας. </p>
    	   </div>
    	</div>
      <div class="footer">
