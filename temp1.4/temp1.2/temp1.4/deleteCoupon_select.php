...
<html>
<head>
<title>Διαγραφή Κουπονιών</title>
...
<div class="wrap">
<ul class="breadcrumb breadcrumb__t"><a class="home" href="addCoupon.php">Προσθήκη Νέου Κουπονιού</a>/Διαγράφη Κουπονιού</ul>
	
	<form method="post" action="deleteCoupon_database.php" name="formadiagrafis">
     ...
     <?php
		...
		if($result->num_rows > 0){
	        ...
	        echo '<th scope="col">Τίτλος Κουπονιού</th>';
	        echo '<th scope="col">Εστιατόριο</th>';
			...
			while($row = $result->fetch_assoc()) {
				...
				$name = $row["RestaurantName"];
		 		$code = $row["Code"];
 				$_SESSION['code'] = $code; 
				echo '<tr onclick="window.location.href= \'showDetailsCoupon.php?coupon='.urlencode($code).' \'">';
