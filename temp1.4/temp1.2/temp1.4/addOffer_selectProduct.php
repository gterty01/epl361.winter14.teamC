...
<ul class="breadcrumb breadcrumb__t">Προσθήκη Νέας Προσφοράς /<a class="home" href="removeOffer.php">Αφαίρεση Προσφοράς - Επαναφορά Αρχικής Τιμής</a></ul>
	

<form id='addOffer' onsubmit="return check();" method="post" accept-charset="utf8" action="addOffer.php" >
     <div class="clear"></div>

<p class="auto-style6"><?php echo $_SESSION['ok_add_offer']; $_SESSION['ok_add_offer'] = " "; ?></p>
