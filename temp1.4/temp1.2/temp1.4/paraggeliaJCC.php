...
if(document.getElementById('antikataboli').checked){
return true;
}
...
if((isset($_POST['arithmosproiontwn']))){
	...
	$_SESSION["posotita$num"]=$posotita;
			$poso=$posotita*$price;
			$varosAntikeimenou=$varos*$posotita;
...
while($row = $result->fetch_assoc()) {
    ...
    echo "<div class='wrap'>";
    	...
    	echo "<h4 class='title'>Τροπος Πληρωμης</h4>";
    	echo "<div class='clear'></div>";
		echo "<form id='paraggelia_troposPlirwmis' onsubmit='return checkTropoPlirwmis();' method='POST' action='episkopisiparaggeliasJCC.php' accept-charset='UTF-8'>";
		echo "<p class='m_text2'><input class='m_text2' type='radio' id ='pistwtiki_karta' name='payment' value='pistwtiki_karta'>Πιστωτική Κάρτα - μέσω JCC</p>";
		echo "<p class='m_text2'><input class='m_text2' type='radio' id ='antikataboli' name='payment' value='antikataboli'>Με αντικαταβολή</p>";
		echo 	"<br>";
