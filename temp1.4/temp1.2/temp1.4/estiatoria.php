...
if($result->num_rows > 0){
	...
	echo	 "<div class='cont span_2_of_3'>";
 	echo 		  	"<h2 class='head'>Εστιατορια</h2>";
	echo "<br>";
	...
	// if ($diathesimotita>0){				
			...
			echo  '<a href="singlecoupon.php?item='.urlencode($couponCode).'">';
			...
			echo "</div>";
			echo	"<div class='sale-box1'><span class='on_sale title_shop'>Κουπονι</span></div>";	
            echo       "<div class='price'>";
			echo		   "<div class='cart-left'>";
			echo				"<p class='title'>";
			echo $estiatorio; echo " - "; echo $titlos;	
			echo "</p>";
			echo	"</div>";
	...
	if($result->num_rows == 0){	
		...
		echo 	"<div class='section group'>";
		echo	 "<div class='cont span_2_of_3'>";
		echo "<h1 class='remove'>ΔΕΝ ΥΠΑΡΧΟΥΝ ΔΙΑΘΕΣΙΜΑ ΚΟΥΠΟΝΙΑ ΠΡΟΣΦΟΡΩΝ ΓΙΑ ΕΣΤΙΑΤΟΡΙΑ</h1>";
		echo "<br>";
		echo "<br>";
