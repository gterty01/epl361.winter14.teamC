  ...
  <div class="main">
		...
		<div class="cont span_2_of_3">
		  	<div class="grid images_3_of_2">
		         ...
		         <div class="desc1 span_3_of_2">
		         	<h3 class="m_3"><?php echo $estiatorio; ?></h3>
					...
					<!--	<form>-->
					 ...
					 <br>
					 <div class="clear"></div>
					<p class="m_text2">Εστιατόριο:&nbsp; <?php echo $estiatorio; ?></p>
				     <p class="m_text2">Διεύθυνση:&nbsp; <?php echo $address; ?> </p>
				     <p class="m_text2">Τηλέφωνο:&nbsp; <?php echo $til; ?></p>

			     </div>
			   <div class="clear"></div>	
	         <div class="toogle">
     	<h3 class="m_3">περιγραφη</h3>
     	<p class="m_text"><?php echo $des; ?></p>
     	<br>
     	<br>
  		<p class="m_text2">Το Cyprus Food Museum προσφέρει στα μέλη του καταστήματός του τα κουπόνια προσφορών σε εστιατόρια δωρεάν, το μόνο που έχετε αν κάνετε είναι να γίνεται μέλος για να μπορέσετε να τα αποκτήσετε απλώς εκτυπώνοντάς τα.</p>
     ...
     <div class="toogle">
		...
		<?php  if(isset($_SESSION['login_user'])){
			echo "<div class='wrap'>";
			echo "<button type='button' onclick=printDiv('kouponi') class='grey' value='ΕΚΤΥΠΩΣΗ ΚΟΥΠΟΝΙΟΥ'>ΕΚΤΥΠΩΣΗ ΚΟΥΠΟΝΙΟΥ</button>";
			echo "</div>";		
			echo "<br>";
			echo "<br>";
			echo "<br>";
			...
			echo "<div class='wrap'>";
			echo "<p class='m_text2'>Γίνετε μέλος ή Συνδεθείτε για να μπορέσετε να εκτυπώσετε το κουπόνι</p>";
			echo "</div>";
			echo "<br>";
			echo "<br>";
			echo "<br>";
