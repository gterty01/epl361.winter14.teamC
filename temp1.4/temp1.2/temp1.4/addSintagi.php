...
function CheckSintagi(){

 	var frm = document.forms["addSintagi"];
	
 	if (frm.title.value == "Τίτλος Συνταγής"){
		alert ('Καταχωρήστε το τίτλο της συνταγής!');
	  	return false;
	}

	var ilika = frm.ilika.value.length;
	var fr1 = parseInt(ilika, 10);
	var sigkrisi = parseInt("1",10)
 		
 	if (fr1 < sigkrisi){
		alert ('Καταχωρήστε τα υλικά της συνταγής!');
	  	return false;
	}

	var perigrafi = frm.description.value.length;
	var fr2 = parseInt(perigrafi, 10);

	if (fr2 < sigkrisi ){
	  	alert ('Καταχωρήστε την περιγραφή εκτέλεσης της συνταγής!');
	  	return false;
	}
...
<div class="login">
       <div class="wrap" style="width: 77%">
	    	    <ul class="breadcrumb breadcrumb__t">Προσθήκη Νέας Συνταγής/<a class="home" href="deleteSintagi.php">Διαγράφη Συνταγής</a></ul>

	     <div class="clear"></div>

	    <p class="auto-style3"><?php echo $_SESSION['error_addSintagi']; $_SESSION['error_addSintagi'] = " "; ?></p>
	    <p class="auto-style6"><?php echo $_SESSION['ok_addSintagi']; $_SESSION['ok_addSintagi'] = " " ; ?></p>
		<br>
	   	<div class="clear"></div>

		   <div class="content-top">
			   <form id='addSintagi' enctype="multipart/form-data" onsubmit="return CheckSintagi()" method="post" action="addSintagi_database.php" accept-charset="utf8" >
					<div class="to">
						<input name="title" type="text" class="auto-style8" value="<?php if($_SESSION['title'] == "") echo "Τίτλος Συνταγής"; else echo $_SESSION['title']; $_SESSION['title'] = ""; ?>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '<?php if($_SESSION['title'] == "") echo "Τίτλος Συνταγής"; else echo $_SESSION['title']; ?>';}" style="width: 42%;">		
					</div>
				
					<div class="clear"></div>

					<div class="text">
					<p class="m_text2" style="width: 37%;color:#008000" >Υλικά:</p>
						 <textarea name="ilika" style="height: 104px; width: 94%;"><?php if($_SESSION['ilika'] == "") echo ""; else echo $_SESSION['ilika'];  $_SESSION['ilika'] = ""; ?></textarea>
	                </div>
					<div class="clear"></div>

					<div class="text">
						<p class="m_text2" style="width: 37%;color:#008000" >Περιγραφή Εκτέλεσης:</p>
						 <textarea name="description" style="height: 179px; width: 94%;"><?php if($_SESSION['Description'] == "") echo ""; else echo $_SESSION['Description'];  $_SESSION['Description'] = "";?></textarea>
	                </div>	                
					<div class="clear"></div>
	             <p class="auto-style1">Φωτογραφία Συνταγής</p>
	             <br>
