	    ...
	    <p class="auto-style6"><?php echo $_SESSION['ok_add_supplier']; $_SESSION['ok_add_supplier'] = " " ; ?></p>
		   <div class="content-top">
			   <form id='addSupplier' enctype="multipart/form-data" onsubmit="return CheckSupplier()" method="post" action="addSupplier_database.php" accept-charset="utf8" >
					...
					<div class="to">
						<input name="d1" type="text" class="text" value="Διεύθυνση 1" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Διεύθυνση 1';}" style="margin-left: 10px; width: 31%;">
					...
					<div class="to">
						<input name="tk" type="text" class="text" value="Ταχυδρομικός Κώδικας" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Ταχυδρομικός Κώδικας';}" style="margin-left: 10px; width: 23%;">
